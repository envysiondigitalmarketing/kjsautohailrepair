        ...
        <>
            ...
            <div className="w-full md:w-11/12  md:flex-col mx-auto  flex justify-center min-h-[400px] my-6 mt-20 max-w-[1700px] rounded-lg">
                <div className="w-7/12 h-full p-3 md:w-full px-9">
                    ...
                    <div className="">
                        <form action="" className="flex flex-col gap-y-4" method="post" name='contact' data-netlify='true' data-netlify-success={console.log(window.location.pathname) && `https://www.kjsautohailrepair.com/${window.location.pathname}`}>
